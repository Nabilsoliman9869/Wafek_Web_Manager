        ...
        private string GetConnectionString()
        {
            try
            {
                ...
                if (System.IO.File.Exists(configPath))
                {
                    ...
                    return $"Server={s.GetProperty("DbServer").GetString()};Database={s.GetProperty("DbName").GetString()};User Id={s.GetProperty("DbUser").GetString()};Password={s.GetProperty("DbPassword").GetString()};TrustServerCertificate=True;Encrypt=False;";
                }
            }
            catch { }
            return "";
